...
static const Entry g_strings[] = {
    ...
    {"tab.move_left", L"en", L"\x25C0"},
    {"tab.move_left", L"ja", L"\x25C0"},
    {"tab.move_left", L"ko", L"\x25C0"},
    {"tab.move_left", L"zh_TW", L"\x25C0"},
    {"tab.move_left", L"zh_CN", L"\x25C0"},
    {"tab.move_right", L"en", L"\x25B6"},
    {"tab.move_right", L"ja", L"\x25B6"},
    {"tab.move_right", L"ko", L"\x25B6"},
    {"tab.move_right", L"zh_TW", L"\x25B6"},
    {"tab.move_right", L"zh_CN", L"\x25B6"},
